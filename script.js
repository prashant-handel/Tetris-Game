...
if (timerId && isGameOver == false) {
leftImgEl.addEventListener("touchstart",()=>{
  moveLeft();
})

rotateImgEl.addEventListener("touchstart",()=>{
  rotate();
})

rightImgEl.addEventListener("touchstart",()=>{
  moveRight();
})

downImgEl.addEventListener("touchstart",()=>{
  moveDown();
})
}
