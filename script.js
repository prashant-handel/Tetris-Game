  ...
  //freeze function
  function freeze() {
    if(current.some(index => squares[currentPosition + index + width].classList.contains('freeze'))) {
      current.forEach(index => squares[currentPosition + index].classList.add('freeze'))
